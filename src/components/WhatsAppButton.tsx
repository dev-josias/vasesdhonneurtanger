...
export default function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute right-full mr-3 px-3 py-1 bg-[#25D366] text-white text-sm rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity">
        Nous contacter
      </span>
    </a>
  );
